      ...
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >User View Our Creditcard Status</font></p>
          </div>
          <div class="cnt_block1">
            <div style="float:left; display:inline; width:620px;   height:overflow;">
            <fieldset style="border: 1px solid #CB974B ;
border-radius: 10px ;">
    <h2>Direct And InDirect Access Details</h2>
				<p><img src="images/arrow.gif" width="20"><a href="rule.jsp" style="text-decoration:none;"><font size="5" color="#33CC99" style="font-weight:bold; ">Rule Protection And Generalization</font></a></p>
				<br>
   <p><img src="images/arrow.gif" width="20"><a href="applyloan.jsp" style="text-decoration:none;"><font size="5" color="#33CC99" style="font-weight:bold; ">Applying Credit Card</font></a></p>
		         <br>
				  <p><font size="4"><img src="images/arrow.gif" width="20"><a href="status.jsp" style="text-decoration:none;"><font size="5" color="#33CC99" style="font-weight:bold; ">CreditCard Status</font></a></p>
