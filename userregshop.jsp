...
<% 
	...
	try{
		...
		String sql1="select max(uid) from shopuserreg";
...
border-radius: 10px ;">
     ...
     <form action="userregshop1.jsp" method="post" name="form" onsubmit="return validation();">
	  <tr> 
              <td width="148" height="37"><font size="3"><strong>User Id</strong></font></td>
              <td width="238"><input type="text" name="uid" value="<%=n%>" id="s" size="25" style="border: 2px solid #CB974B" /></td>
            </tr>
            <tr> 
              <td width="148" height="37"><font size="3"><strong>User name</strong></font></td>
              <td width="238"><input type="text" name="username" id="s" size="25" style="border: 2px solid #CB974B" /></td>
            </tr>
            <tr> 
              <td height="35"><font size="3"><strong>Password</strong></font></td>
              <td><input type="password" name="password" id="s" size="25" style="border: 2px solid #CB974B"/></td>
            </tr>
			  <tr> 
              <td width="148" height="37"><font size="3"><strong>EmailId</strong></font></td>
              <td width="238"><input type="text" name="email" id="s" size="25" style="border: 2px solid #CB974B" /></td>
            </tr>
			  <tr> 
              <td width="148" height="37"><font size="3"><strong>Mobile No</strong></font></td>
              <td width="238"><input type="text" name="mno" id="s" size="25" style="border: 2px solid #CB974B" /></td>
            </tr>
			  <tr> 
              <td width="148" height="37"><font size="3"><strong>Address</strong></font></td>
              <td width="238"><input type="text" name="address" id="s" size="25" style="border: 2px solid #CB974B" /></td>
            </tr>
            <tr> 
              <td height="39"></td>
