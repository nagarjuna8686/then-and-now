...
border-radius: 10px ;">
     ...
     <form method="get" action="searchview.jsp" onsubmit="return validation()" name="form" >
	  <tr> 
              <td width="148" height="37"><font size="3"><strong>Search Data</strong></font></td>
              <td width="238"><input type="text" name="category" value="<%=b%>"></td>
            <tr> 
              <td width="148" height="37"><font size="3"><strong>Search Data</strong></font></td>
              <td width="238">
			  <select name="category">
 <option value="category">------Select Itemname------</option>
  <%
  String iname=null;
...
String sql="select distinct iname from productupload where category='"+b+"'" ;
...
System.out.println("fdfvdgvbfdbgfv"+iname);
      }
