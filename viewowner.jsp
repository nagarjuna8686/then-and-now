      ...
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >View All Online Shopping Owner Details</font></p>
          </div>
...
border-radius: 10px ;">
	 ...
	 <table width="590" height="50" border="1px" align="center">
         <form action="#" method="post" name="form";>
          <tr bgcolor="#DEDBDC"> 
            <th width="147" height="41"><font color="#000000"><strong>Owner ID</strong></font></th>
            <th width="144"><font color="#000000"><strong>Owner Name</strong></font></th>
            <th width="144"><font color="#000000"><strong>Password</strong></font></th>
            <th width="157"><font color="#000000"><strong>Email</strong></font></th>
			  <th width="144"><font color="#000000"><strong>Mobile</strong></font></th>
			    <th width="144"><font color="#000000"><strong>Address</strong></font></th>
...
try
{
  ...
  while(rs.next())
   ...
   %>
          <tr> 
            <td align="center"><font color="#257268"><strong><%=rs.getInt("oid")%></strong></font></td>
			
            <td align="center"><font color="#257268"><strong><%=rs.getString("ownername")%></strong></font></td>
            <td align="center"><font color="#257268"><strong><%=rs.getString("pwd")%></strong></font></td>
			<td align="center"><font color="#257268"><strong><%=rs.getString("emailid")%></strong></font></td>
			<td align="center"><font color="#257268"><strong><%=rs.getString("mbl_no")%></strong></font></td>
			<td align="center"><font color="#800040"><strong><%=rs.getString("addr")%></strong></font></td>
          </tr>
          <%}
