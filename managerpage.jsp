      ...
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >Manager Login</font></p>
          </div>
...
border-radius: 10px ;">
	  ...
	  <h2>Direct And InDirect Accessed CreditCard Applied Users Details</h2>
              	
        <p ><img src="images/arrow.gif" width="20"><a href="direct.jsp" style="text-decoration:none;"><font size="4" color="#006633" style="font-weight:bold;">Direct Accessed CreditCard Applied Users Details</font></a></p>
   <p><img src="images/arrow.gif" width="20"><a href="indirect.jsp" style="text-decoration:none;"><font size="4" color="#006633" style="font-weight:bold;">Indirect Accessed CreditCard Applied Users Details</font></a></p>
		         
				  <p><img src="images/arrow.gif" width="20"><a href="graph.jsp" style="text-decoration:none;"><font size="4" color="#006633" style="font-weight:bold;">CreditCard Status In Graphical Representation</font></a></p>
