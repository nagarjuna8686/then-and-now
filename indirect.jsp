...
<div id="mainblock">
      ...
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >Indirectly Collected Credit Card Applied User Details</font></p>
          </div>
 ...
 <tr bgcolor="#DEDBDC"> 
            ...
            <th width="157"><font color="#000000"><strong>Nationality</strong></font></th>
			  ...
			  <th width="144"><font color="#000000"><strong>Click To View Full Details</strong></font></th>
...
try
{
  Connection con;
   ...
   String s = "select * from loanform where age <=40 And status='processing' ";
  ...
  while(rs.next())
   ...
   %>
          <tr> 
            <td align="center"><font color="#800080" size="4"><strong><%=rs.getInt("id")%></strong></font></td>
			
            <td align="center"><font color="#800080" size="4"><strong><%=rs.getString("name")%></strong></font></td>
            <td align="center"><font color="#800080" size="4"><strong><%=rs.getString("gender")%></strong></font></td>
			<td align="center"><font color="#800080" size="4"><strong><%=rs.getString("nationality")%></strong></font></td>
			<td align="center"><font color="#800080" size="4"><strong><%=rs.getString("religion")%></strong></font></td>
			<td align="center"><font color="#660000"><strong><%=rs.getString("status")%></strong></font></td>
            <td> <a href="indirect1.jsp?id1=<%=rs.getInt("id")%>"><img src="images/View-Details.png" width="150" height="50"></a></td>
          </tr>
          <%}
