...
<%
				...
				String mylocation=null,myincome=null;
				int id=0;
	...
	myincome=rs.getString("income");
		...
		if((Integer.parseInt(myincome))>=(Integer.parseInt(ruleincome))){
			...
			<%}
					...
					response.sendRedirect("direct3.jsp?id3="+id2+"");
			}
		}
		else{
			response.sendRedirect("direct3.jsp?id3="+id2+"");
		  ...
		  <tr>
		   ...
		   <tr> 
            ...
            <td width="100" class="phone"><font color="#006666" size="4"><strong>:<%=rs.getString("construct")%></strong></font></td>
             ...
             <tr> 
            <td height="70"></td>
            <td><a href="updatestatus.jsp?id4=<%=id2%>"><input type="submit" name="B1" class="button2" value="Credit cart Granting" style="border: 1px solid #CB974B"></a></td> 
           <td>   <a href="updatestatus1.jsp?id4=<%=id2%>"><input type="reset" name="reset" class="button2" value="Denied" style="border: 1px solid #CB974B"></a></td>
          </tr>
