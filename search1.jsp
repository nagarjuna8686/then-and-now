...
border-radius: 10px ;">
     ...
     <form method="get" action="search1.jsp" onsubmit="return validation()" name="form" >
            <tr> 
              <td width="148" height="37"><font size="3"><strong>Search Data</strong></font></td>
              <td width="238"><input type="text" name="msg" id="s" size="25" style="border: 2px solid #CB974B" /></td>
            </tr>
