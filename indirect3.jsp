	   ...
	   <table width="590" align="left">
         <tr>
		  ...
		  <tr>
           ...
           <tr> 
            <td height="70"></td>
  <td><a href="updatestatus.jsp?id4=<%=id3%>"><input type="submit" name="B1" class="button2" value="CreditCardGranting" style="border: 1px solid #CB974B"></a></td> 
           <td>   <a href="updatestatus1.jsp?id4=<%=id3%>"><input type="reset" name="reset" class="button2" value="CreditCardDenied" style="border: 1px solid #CB974B"></a></td>
              </td>
          </tr>
