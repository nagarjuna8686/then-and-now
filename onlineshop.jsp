  ...
  <div style="width:1000px; align:center; border:1px solid #C7244B;"><img src="images/title.png" width="1000" height="100"></div>
    ...
    <div id="contentblock">
      <div id="leftpanel">
        ...
        <a href="#"><img src="images/lp_image.gif" width="279" height="129" alt="" class="lp_image" /></a> </div>
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >Online Shopping CyberCrime Markets</font></p>
          </div>
          <div class="cnt_block1">
            <div style="float:left; display:inline;  height:overflow;">
             <p align="justify">&nbsp;&nbsp;&nbsp;Online shopping (sometimes known as e-tail from "electronic retail" or e-shopping) is a form
			  of electronic commerce which allows consumers to directly buy goods or services from a seller over the Internet using a web browser.
			   Alternative names are: e-web-store,
			  e-shop, e-store, Internet shop, web-shop, web-store, online store, online storefront and virtual store. Mobile commerce (or m-commerce) 
...
the process is 
called business-to-consumer (B2C) online shopping. In the case where a business buys from another business, the process is called business-to-business
 (B2B) online shopping. 
The largest of these online retailing corporations are Alibaba, Amazon.com, and eBay.</p><br><br>
<div align="center"><img src="images/online-shopping.jpg" width="600"  height="400"></div>
            </div>
           </div>
        </div>
