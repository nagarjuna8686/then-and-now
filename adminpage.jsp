      ...
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >View All The Details for Online Shopping</font></p>
          </div>
...
border-radius: 10px ;">
	  ...
	  <h2>View Details of Online Shopping</h2>
              	
        <p ><img src="images/arrow.gif" width="20"><a href="viewuser.jsp" style="text-decoration:none;"><font size="4" color="#006633" style="font-weight:bold;">View Online Shopping Users Details</font></a></p>
   <p><img src="images/arrow.gif" width="20"><a href="viewowner.jsp" style="text-decoration:none;"><font size="4" color="#006633" style="font-weight:bold;">View Online Shopping Owner Details</font></a></p>
		         
				  <p><img src="images/arrow.gif" width="20"><a href="viewcomment.jsp" style="text-decoration:none;"><font size="4" color="#006633" style="font-weight:bold;">View User Comments About Products</font></a></p>
