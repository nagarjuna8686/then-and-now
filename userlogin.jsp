...
border-radius: 10px ;">
     ...
     <form action="userlogin1.jsp" method="post" name="form" onsubmit="return validation();">
            <tr> 
              <td width="148" height="37"><font size="3"><strong>UserEmailId</strong></font></td>
            ...
            <tr> 
              ...
              <td><input type="password" name="pass" id="s" size="25" style="border: 2px solid #CB974B"/></td>
            </tr>
            <tr> 
              <td height="39"></td>
