...
<%
				...
				String rulelocation=null,ruleincome=null,ruleemptype=null;
				int id=0;
				...
				try
				{
					...
					String qry="select * from loanform where id='"+id1+"'";
   ...
   %>
    <%
				...
				try
				{
					...
					String qry1="select * from threshold";
					rs1 =st1.executeQuery(qry1);
		
while(rs1.next())
   {
    rulelocation=rs1.getString("location"); 
	session.setAttribute("rulelocation",rulelocation);
	ruleincome=rs1.getString("income"); 
	session.setAttribute("ruleincome",ruleincome);
	ruleemptype=rs1.getString("emptype"); 
	session.setAttribute("ruleemptype",ruleemptype);
    ...
    <div id="contentblock">
      <div id="leftpanel">
		...
		<form action="#" method="get">
		  ...
		  <p><strong><font color="#FF6600" size="4">Bank: ChennaiBranch</font></strong></p>   
				  <p><strong><font color="#FF6600" size="4">Set Of Rules</font></strong></p>
     
		
		<p>1.&nbsp;&nbsp;Location:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#6633FF" size="4"><%=rs1.getString("location")%></font></p>
		<p>2.&nbsp;&nbsp;AnnualIncome:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#6633ff" size="4"><%=rs1.getString("income")%></font></p>
		<p>3.&nbsp;&nbsp;Race:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#6633ff" size="4"><%=rs1.getString("emptype")%></font></p>
		<p>4.&nbsp;&nbsp;Threshold:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#6633ff" size="4">2</font></p>
		
		
		<p><font color="#FF6600" size="4">SensitiveAttributes</font></strong></p>
		 <p align="justify"> InDirect discrimination occurs when decisions are made 
        based on nonsensitive attributes.</p>
		<p>1.&nbsp;&nbsp;Age&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
		<p>2.&nbsp;&nbsp;Gender&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
		<p>3.&nbsp;&nbsp;Religion&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      ...
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >Indirectly Accessed Credit Card User Detail</font></p>
          </div>
         ...
         <tr>
          ...
          <tr> 
                    <td width="133" height="36" class="paragraping"><strong>Marital 
                      Status</strong></td>
            <td width="150" class="fielditem"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("marital"))%></strong></font></td>
          <td width="141" height="36" class="paragraping"><strong>&nbsp;&nbsp;&nbsp;Date Of Birth</strong></td>
           ...
           <tr> 
            ...
            <td width="150" class="phone"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("age"))%></strong></font></td>
			   <td width="141" height="36" class="paragraping"><strong>&nbsp;&nbsp;&nbsp;Gender</strong></td>
          <td width="100" class="fielditem"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("gender"))%></strong></td>
          </tr>
		       <tr> 
            <td width="133" height="40" class="paragraping"><strong>Nationality</strong></td>
            <td width="150" class="phone"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("nationality"))%></strong></font></td>
			   <td width="141" height="40" class="paragraping"><strong>&nbsp;&nbsp;&nbsp;Religion</strong></td>
             <td width="100" class="fielditem"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("religion"))%></strong></font></td>
          </tr>
		  ...
		  <tr>
		   ...
		   <tr> 
            ...
            <tr> 
            <td height="70"></td>
            <td colspan="3"><a href="indirect2.jsp?id2=<%=rs.getInt("id")%>"><input type="submit" name="B1" class="button2" value="Click To ViewFullDetails" style="border: 1px solid #CB974B"></a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
              </td>
          </tr>
