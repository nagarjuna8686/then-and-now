...
<%
				...
				EBCDIC privacy_preserving=new EBCDIC();
				...
				try
				{
					...
					String qry="select * from loanform where id='"+id3+"' ";
...
<div id="mainblock">
  ...
  <div style="width:1000px; align:center; border:1px solid #C7244B;"><img src="images/title.png" width="1000" height="100"></div>
	  ...
	  <a href="userlogin.jsp" class="tp_menu2">User Login</a> <img src="images/tp_divider.gif" width="2" height="39" alt="" class="tp_divider" />
	   ...
	   <a href="direct.jsp" class="tp_menu2">Back</a> </div>
      ...
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >View Credit Card User Application Detail</font></p>
          </div>
	   ...
	   <table width="590" align="left">
         <tr>
          ...
          <tr> 
            ...
            <td width="150" class="name"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("address"))%></strong></font></td>
          </tr>
          <tr> 
                    <td width="133" height="35" class="paragraping"><strong>ContactNo</strong></td>
            <td width="150" class="email"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("contact"))%></strong></font></td>
			            <td width="141" height="35" class="paragraping"><strong>&nbsp;&nbsp;&nbsp;PAN</strong></td>
            <td width="100" class="email"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("pan"))%></strong></font></td>
          </tr>
          <tr> 
          ...
          <td width="141" height="36" class="paragraping"><strong>&nbsp;&nbsp;&nbsp;Date Of Birth</strong></td>
            <td width="100" class="phone"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("dateofbirth"))%></strong></font></td>
		  </tr>
           <tr> 
          ...
          <td width="100" class="fielditem"><font color="#006666" size="4"><strong>:<%=rs.getString("gender")%></strong></td>
          </tr>
		       <tr> 
		  ...
		  <tr>
            ...
            <td width="150" class="phone"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("loanpurpose"))%></strong></font></td>
		  </tr>
		  <tr>
           ...
           <td width="150" class="fielditem"><font color="#006666" size="4"><strong>:<%=rs.getString("emptype")%></strong></font></td>
            ...
            <td width="100" class="phone"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("income"))%></strong></font></td>
          </tr>
		       <tr> 
            <td width="133" height="44" class="paragraping"><strong>No.OfYears in Service</strong></td>
            <td width="150" class="phone"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("service"))%></strong></font></td>
			   <td width="141"  height="44" class="paragraping"><strong>&nbsp;&nbsp;&nbsp;Do u Have Bank Ac</strong></td>
            <td width="100" class="phone"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("loanamount"))%></strong></font></td>
          </tr>
		
		   <tr> 
            <td width="133" height="44" class="paragraping"><strong>Profession</strong></td>
            <td width="150" class="phone"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("project"))%></strong></font></td>
			   <td width="141" height="44" class="paragraping"><strong>&nbsp;&nbsp;&nbsp;Company Name </strong></td>
            <td width="100" class="phone"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("propertyadd"))%></strong></font></td>
          </tr>
		    <tr> 
            <td width="133" height="44" class="paragraping"><strong>Designation</strong></td>
            <td width="150" class="phone"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("cost"))%></strong></font></td>
			   <td width="141" height="44" class="paragraping"><strong>&nbsp;&nbsp;&nbsp;Monthly salary </strong></td>
            <td width="100" class="phone"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("construct"))%></strong></font></td>
          </tr>
           <tr> 
            <td height="70"></td>
  <td><a href="updatestatus.jsp?id4=<%=id3%>"><input type="submit" name="B1" class="button2" value="CreditCardGranting" style="border: 1px solid #CB974B"></a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
              <a href="updatestatus1.jsp?id4=<%=id3%>"><input type="reset" name="reset" class="button2" value="CreditCardDenied" style="border: 1px solid #CB974B"></a></td>
              </td>
          </tr>
