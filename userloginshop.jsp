      ...
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >User Login</font></p>
          </div>
...
border-radius: 10px ;">
     ...
     <form action="userloginshop1.jsp" method="post" name="form" onsubmit="return validation();">
            <tr> 
            ...
            <tr> 
              ...
              <td><input type="submit" name="submit" class="button2" value="Login" style="border: 2px solid #CB974B"> 
                <input type="reset" name="reset" class="button2" value="Clear" style="border: 2px solid #CB974B"> 
							...
							<p align="center" >	<font color="#663333" size="4"><b>If you are a new user </font><a href="userregshop.jsp" style="text-decoration:none;">&nbsp;&nbsp;&nbsp;SignUp</a></b></p>
