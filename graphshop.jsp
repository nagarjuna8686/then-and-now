...
psmt =con.prepareStatement("select avg(rate),count(username) from comments where id='"+p+"'");
...
System.out.println("jai"+rate);
System.out.println("file id jai"+z);
...
// Change type to "bar", "splineArea", "area", "spline", "pie",etc.
				  ...
				  { label: "total rate", y:<%=rate%> },
				  { label: "total Number of users", y: <%=z%> }
      ...
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >Graph Representation of User Review Rating</font></p>
          </div>
