      ...
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >Credit Card Applied User Details</font></p>
          </div>
  ...
  while(rs.next())
   ...
   %>
          <tr> 
            ...
            <td align="center"><font color="#257268"><strong><%=rs.getString("name")%></strong></font></td>
            <td align="center"><font color="#257268"><strong><%=rs.getString("gender")%></strong></font></td>
			<td align="center"><font color="#257268"><strong><%=rs.getString("nationality")%></strong></font></td>
			<td align="center"><font color="#257268"><strong><%=rs.getString("religion")%></strong></font></td>
			<td align="center"><font color="#800040"><strong><%=rs.getString("status")%></strong></font></td>
            <td> <a href="direct1.jsp?id1=<%=rs.getInt("id")%>"><img src="images/View-Details.png" width="150" height="50"></a></td>
          </tr>
          <%}
