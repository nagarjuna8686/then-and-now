      ...
      <div id="contentpanel">
        <div style="float:left; ">
          <div class="cnt_tile2"> <img src="images/tp_btn1.gif" width="15" height="15" alt="" class="tp_btn1" />
            <p class="tp_heading"><font size="5" >View All Online Shopping User Details</font></p>
          </div>
	 ...
	 <table width="590" height="50" border="1px" align="center">
         <form action="#" method="post" name="form";>
          <tr bgcolor="#DEDBDC"> 
            ...
            <th width="144"><font color="#000000"><strong>User Name</strong></font></th>
...
try
{
  Connection con;
   ...
   String s = "select * from shopuserreg ";
  ...
  while(rs.next())
   ...
   %>
          <tr> 
            <td align="center"><font color="#257268"><strong><%=rs.getInt("uid")%></strong></font></td>
			
            <td align="center"><font color="#257268"><strong><%=rs.getString("username")%></strong></font></td>
            <td align="center"><font color="#257268"><strong><%=rs.getString("password")%></strong></font></td>
			<td align="center"><font color="#257268"><strong><%=rs.getString("email")%></strong></font></td>
			<td align="center"><font color="#257268"><strong><%=rs.getString("mno")%></strong></font></td>
			<td align="center"><font color="#800040"><strong><%=rs.getString("address")%></strong></font></td>
          </tr>
          <%}
