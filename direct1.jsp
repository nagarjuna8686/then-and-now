...
<%
				...
				String rulelocation=null,ruleincome=null;
				int id=0;
  ...
  <div style="width:1000px; align:center; border:1px solid #C7244B;"><img src="images/title.png" width="1000" height="100"></div>
    ...
    <div id="contentblock">
      <div id="leftpanel">
		...
		<p>1.&nbsp;&nbsp;Location:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#006666" size="4"><%=rs1.getString("location")%></font></p>
		<p>2.&nbsp;&nbsp;AnnualIncome:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#006666" size="4"><%=rs1.getString("income")%></font></p>
		<p>3.&nbsp;&nbsp;Threshold:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#006666" size="4">2</font></p>
		
		
		<p><font color="#FF6600" size="4">SensitiveAttributes</font></strong></p>
		 <p align="justify"> Direct Accessed User Details using decisions are made 
        based on sensitive attributes.</p>
		<p>1.&nbsp;&nbsp;Age&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
		<p>2.&nbsp;&nbsp;Gender&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
		<p>3.&nbsp;&nbsp;Religion&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
	   ...
	   <table width="590" align="left">
         <tr>
		  ...
		  <tr>
           ...
           <td width="150" class="fielditem"><font color="#006666" size="4"><strong>:<%=privacy_preserving.encrypt(rs.getString("emptype"))%></strong></font></td>
           ...
           <tr> 
            <td height="70"></td>
            <td colspan="3"><a href="direct2.jsp?id2=<%=rs.getInt("id")%>"><input type="submit" name="B1" class="button2" value="Click To ViewFullDetails" style="border: 1px solid #CB974B"></a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
              </td>
          </tr>
